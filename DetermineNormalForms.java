...
public class DetermineNormalForms {
    ...
    private List<Closure> TwoNFViolatingFDs;
    ...
    public List<Closure>  getTwoNFViolatingFDs() {
        return TwoNFViolatingFDs;
    }
	...
	private void calculateSecondNormalForm() {
        ...
        Set<Closure> TwoNFSet = new HashSet<Closure>();
        for(Closure c: failedClosures) {
            TwoNFSet.add(c);
        }

        TwoNFViolatingFDs = new ArrayList<Closure>();
        for(Closure c : TwoNFSet) {
            TwoNFViolatingFDs.add(c);
        }
    ...
    public boolean isIn2NF() {
        return isSecondNormalForm;
    }
